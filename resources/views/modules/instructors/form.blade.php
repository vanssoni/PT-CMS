...
<div class="row mb10">
    <div class="user-profile  col-md-12">
        <img src="{{@$instructor->user->profile_pic ?? url('/assets/img/avatars/profile_avatar.jpg')}}"  class="img-responsive" alt="Profile Picture" id="image-preview">
    </div>
    <div class="col-md-6 pt18">
    ...
    <div class="col-md-6 pt18">
        <div class="form-group">
            <label for="password" class="floating-label control-label">Profile Picture:</label>
    ...
    @foreach($permissions as $key => $value)
        ...
        @foreach($value as $permission)
            <div class="checkbox-custom-mod checkbox-primary mb5 col-md-3">
                <input type="checkbox"  {{ ( @$instructor->user  ?  ($instructor->user->can($permission) ? 'checked' : '') : '' )}} id="checkbox-{{$permission}}" class='' name="permissions[]" value='{{$permission}}' > 
