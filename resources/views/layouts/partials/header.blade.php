                                    ...
                                    <div id="nav-tab2" class="tab-pane scroller-navbar chat-widget" role="tabpanel">
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#">
                                                    <img class="media-object" alt="64x64" src="assets/img/avatars/chat_1.jpg">
                                                </a>
                                            </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-right">
                                                <a href="#">
                                                    <img class="media-object" alt="64x64" src="assets/img/avatars/chat_2.jpg">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="media">
                                        ...
                                        <ul class="media-list" role="menu">
                                            <li class="media">
                                                <a class="media-left" href="#"> 
                                                    <img src="assets/img/avatars/4.jpg" class="" alt="avatar">
                                                </a>
                                            ...
                                            <li class="media">
                                                <a class="media-left" href="#"> 
                                                    <img src="assets/img/avatars/3.jpg" class="" alt="avatar">
                                                </a>
                                            ...
                                            <li class="media">
                                                <a class="media-left" href="#"> 
                                                    <img src="assets/img/avatars/2.jpg" class="" alt="avatar">
                                                </a>
                                            ...
                                            <li class="media">
                                                <a class="media-left" href="#"> 
                                                    <img src="assets/img/avatars/1.jpg" class="" alt="avatar">
                                                </a>
